...
export default function Footer() {
  return (
    <footer className="bg-[#0a0a0a]">
      {/* Main Footer Content */}
      <div className="border-t border-[#222] border-b border-b-[#222] py-12">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Logo & Social */}
            <div>
              <h3 className="text-2xl font-bold tracking-wider font-[family-name:var(--font-playfair)] mb-2">
                CYRUS
              </h3>
              <p className="text-gray-400 mb-4">Hair & Beauty</p>
              <a
            ...
            {/* Schnellkontakt */}
            <div>
              <h4 className="text-lg font-semibold mb-4">Schnellkontakt</h4>
